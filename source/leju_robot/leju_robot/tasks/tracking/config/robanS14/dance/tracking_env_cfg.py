...
from leju_robot.tasks.tracking.config.robanS14.dance.robanS14 import RobanS14_ACTION_SCALE, RobanS14_CYLINDER_CFG
##
# Pre-defined configs
##
...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfg(
        motion_file=f"{MOTION_DIR}/mimic/npz_data/robanS14_charleston_dance_50fps.npz",
        asset_name="robot",
...
class RewardsCfg:
    ...
    #         "sensor_cfg": SceneEntityCfg(
    #             "contact_forces",
    #             body_names=[r"^(?!base_link$)(?!leg_l4_link$)(?!leg_r4_link$)(?!leg_l6_link$)(?!leg_r6_link$)(?!zarm_l4_link$)(?!zarm_r4_link$).+$"],
    #         ),
    #         "threshold": 1.0,
    #     },
    # )
    ...
    leg1_contact_forces = RewTerm(
        func=mdp.body_contact_forces,
        weight=-2,
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_forces",
                body_names=["leg_l1_link", "leg_r1_link"],
            ),
    ...
    hand_contact_vel = RewTerm(
        func=mdp.body_contact_vel,
        weight=-20.0,
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_forces",
    ...
    hand_slide_vel = RewTerm(
        func=mdp.body_slide_vel,
        weight=-0.5,
        params={
            "sensor_cfg": SceneEntityCfg(
                "contact_forces", body_names=["zarm_[l,r]4_link"]),
            "asset_cfg": SceneEntityCfg(
                "robot", body_names=["zarm_[l,r]4_link"]),
            "contact_threshold": 50.0  # total_mass * 9.8 * 0.8 * (1/4)
        },
    )
