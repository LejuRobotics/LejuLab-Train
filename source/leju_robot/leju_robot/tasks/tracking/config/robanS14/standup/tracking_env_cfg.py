...
from leju_robot.tasks.tracking.config.robanS14.standup.robanS14 import RobanS14_ACTION_SCALE, RobanS14_CYLINDER_CFG
##
# Pre-defined configs
##
...
class CommandsCfg:
    ...
    motion = mdp.MotionCommandCfg(
        motion_file=f"{MOTION_DIR}/mimic/npz_data/robanS14_prone_50fps.npz",
        asset_name="robot",
