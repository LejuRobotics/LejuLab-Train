...
class IsaacLabWrapper(Wrapper):
    ...
    def step(self, actions: torch.Tensor) -> Tuple[torch.Tensor, torch.Tensor, torch.Tensor, torch.Tensor, Any]:
        ...
        self._info["observations"] = {
            "policy": flatten_tensorized_space(tensorize_space(self.observation_space, observations["policy"])),
            "critic": flatten_tensorized_space(tensorize_space(self.state_space, observations["critic"])) if self.state_space else None,
        }
