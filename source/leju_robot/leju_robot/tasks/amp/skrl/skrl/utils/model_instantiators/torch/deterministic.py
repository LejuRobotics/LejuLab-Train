...
def deterministic_model(
    ...
    **kwargs,
    ...
    def __init__(self, observation_space, state_space, action_space, device, clip_actions):
        Model.__init__(self, observation_space, state_space, action_space, device)
    ...
    return _locals["DeterministicModel"](
        observation_space=observation_space, state_space=state_space, action_space=action_space, device=device, clip_actions=clip_actions
    )
