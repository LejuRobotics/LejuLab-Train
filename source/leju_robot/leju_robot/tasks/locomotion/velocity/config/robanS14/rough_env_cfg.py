...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    # robots
    robot: ArticulationCfg = RobanS14_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
    # sensors
...
@configclass
class RobanS14RoughEnvCfg(LocomotionVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.actions.joint_pos.joint_names = RobanS14_CFG.preserve_joint_order.joint_names
        self.observations.policy.joint_pos_rel.params = {"asset_cfg": RobanS14_CFG.preserve_joint_order}
        self.observations.policy.joint_vel_rel.params = {"asset_cfg": RobanS14_CFG.preserve_joint_order}
        self.observations.critic.joint_pos_rel.params = {"asset_cfg": RobanS14_CFG.preserve_joint_order}
        self.observations.critic.joint_vel_rel.params = {"asset_cfg": RobanS14_CFG.preserve_joint_order}

@configclass
class RobanS14RoughEnvCfg_PLAY(RobanS14RoughEnvCfg):
    def __post_init__(self):
        # post init of parent
        super().__post_init__()
